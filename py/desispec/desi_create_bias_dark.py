...
Usage:
    1) go to an empty folder with enough space. 
    2) Run:
       python3 desi_create_bias_dark.py -n 20200729 -r 0060633 0060634 0060635 0060636 0060637 0060638 0060639 0060640 0060641 0060642
    3) Run python3 desi_bias_dark_1d_model.py
