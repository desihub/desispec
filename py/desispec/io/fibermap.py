...
fibermap_columns = (('TARGETID',                   'i8',             '', 'Unique DESI target ID',                        'empty'),
                    ...
                    ('HELIOCOR',                   'f4',             '', 'Multiplicative barycentric correction at extraction', 'spectra'),
                    ...
                    ('MIN_MJD',                    'f8',            'd', 'Minimum MJD contributing to fiber coadd',      'coadd'),
                    ('MEAN_MJD',                   'f8',            'd', 'Mean MJD across fibers contributing to coadd', 'coadd'),
                    ('MAX_MJD',                    'f8',            'd', 'Maximum MJD contributing to fiber coadd',      'coadd'),
                    ('FIRSTNIGHT',                 'i4',             '', 'First night tile was observed (YYYYMMDD)',     'coadd'),
                    ('LASTNIGHT',                  'i4',             '', 'Last night tile was observed (YYYYMMDD)',      'coadd'),
