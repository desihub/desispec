...
def findfile(filetype, night=None, expid=None, camera=None, brickname=None,
    ...
    location = dict(
        ...
        ql_boxextract_fig = '{specprod_dir}/exposures/{night}/ql-boxextract-{camera}-{expid:08d}.png',
        ql_boxextract_file = '{specprod_dir}/exposures/{night}/ql-boxextract-{camera}-{expid:08d}.yaml',
        ql_countbins_fig = '{specprod_dir}/exposures/{night}/ql-countbins-{camera}-{expid:08d}.png',
        ql_countbins_file = '{specprod_dir}/exposures/{night}/ql-countbins-{camera}-{expid:08d}.yaml',
        ql_countpix_fig = '{specprod_dir}/exposures/{night}/ql-countpix-{camera}-{expid:08d}.png',
        ql_countpix_file = '{specprod_dir}/exposures/{night}/ql-countpix-{camera}-{expid:08d}.yaml',
        ql_fiberflat_fig = '{specprod_dir}/exposures/{night}/ql-fiberflat-{camera}-{expid:08d}.png',
        ql_fiberflat_file = '{specprod_dir}/exposures/{night}/ql-fiberflat-{camera}-{expid:08d}.yaml',
        ql_getbias_fig = '{specprod_dir}/exposures/{night}/ql-getbias-{camera}-{expid:08d}.png',
        ql_getbias_file = '{specprod_dir}/exposures/{night}/ql-getbias-{camera}-{expid:08d}.yaml',
        ql_getrms_fig = '{specprod_dir}/exposures/{night}/ql-getrms-{camera}-{expid:08d}.png',
        ql_getrms_file = '{specprod_dir}/exposures/{night}/ql-getrms-{camera}-{expid:08d}.yaml',
        ql_initial_fig = '{specprod_dir}/exposures/{night}/ql-initial-{camera}-{expid:08d}.png',
        ql_initial_file = '{specprod_dir}/exposures/{night}/ql-initial-{camera}-{expid:08d}.yaml',
        ql_integ_fig = '{specprod_dir}/exposures/{night}/ql-integ-{camera}-{expid:08d}.png',
        ql_integ_file = '{specprod_dir}/exposures/{night}/ql-integ-{camera}-{expid:08d}.yaml',
        ql_preproc_fig = '{specprod_dir}/exposures/{night}/ql-preproc-{camera}-{expid:08d}.png',
        ql_preproc_file = '{specprod_dir}/exposures/{night}/ql-preproc-{camera}-{expid:08d}.yaml',
        ql_skycont_fig = '{specprod_dir}/exposures/{night}/ql-skycont-{camera}-{expid:08d}.png',
        ql_skycont_file = '{specprod_dir}/exposures/{night}/ql-skycont-{camera}-{expid:08d}.yaml',
        ql_skypeak_fig = '{specprod_dir}/exposures/{night}/ql-skypeak-{camera}-{expid:08d}.png',
        ql_skypeak_file = '{specprod_dir}/exposures/{night}/ql-skypeak-{camera}-{expid:08d}.yaml',
        ql_skyresid_fig = '{specprod_dir}/exposures/{night}/ql-skyresid-{camera}-{expid:08d}.png',
        ql_skyresid_file = '{specprod_dir}/exposures/{night}/ql-skyresid-{camera}-{expid:08d}.yaml',
        ql_skysub_fig = '{specprod_dir}/exposures/{night}/ql-skysub-{camera}-{expid:08d}.png',
        ql_skysub_file = '{specprod_dir}/exposures/{night}/ql-skysub-{camera}-{expid:08d}.yaml',
        ql_snr_fig = '{specprod_dir}/exposures/{night}/ql-snr-{camera}-{expid:08d}.png',
        ql_snr_file = '{specprod_dir}/exposures/{night}/ql-snr-{camera}-{expid:08d}.yaml',
        ql_xwsigma_fig = '{specprod_dir}/exposures/{night}/ql-xwsigma-{camera}-{expid:08d}.png',
        ql_xwsigma_file = '{specprod_dir}/exposures/{night}/ql-xwsigma-{camera}-{expid:08d}.yaml',
