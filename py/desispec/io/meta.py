...
def findfile(filetype, night=None, expid=None, camera=None, groupname=None,
    ...
    download=False, outdir=None, qa_dir=None):
    ...
    Options:
        ...
        qa_dir : defaults to $DESI_SPECTRO_REDUX/$SPECPROD/QA/ if not provided
    ...
    location = dict(
        ...
        qa_data = '{qa_dir}/exposures/{night}/{expid:08d}/qa-{camera}-{expid:08d}.yaml',
        qa_data_exp = '{qa_dir}/exposures/{night}/{expid:08d}/qa-{expid:08d}.yaml',
        qa_bootcalib = '{qa_dir}/calib2d/psf/{night}/qa-psfboot-{camera}.pdf',
        qa_sky_fig = '{qa_dir}/exposures/{night}/{expid:08d}/qa-sky-{camera}-{expid:08d}.png',
        qa_skychi_fig = '{qa_dir}/exposures/{night}/{expid:08d}/qa-skychi-{camera}-{expid:08d}.png',
        qa_flux_fig = '{qa_dir}/exposures/{night}/{expid:08d}/qa-flux-{camera}-{expid:08d}.png',
        qa_toplevel_html = '{qa_dir}/qa-toplevel.html',
        qa_calib = '{qa_dir}/calib2d/{night}/qa-{camera}-{expid:08d}.yaml',
        qa_calib_html = '{qa_dir}/calib2d/qa-calib2d.html',
        qa_calib_exp = '{qa_dir}/calib2d/{night}/qa-{expid:08d}.yaml',
        qa_calib_exp_html = '{qa_dir}/calib2d/{night}/qa-{expid:08d}.html',
        qa_exposures_html = '{qa_dir}/exposures/qa-exposures.html',
        qa_exposure_html = '{qa_dir}/exposures/{night}/{expid:08d}/qa-{expid:08d}.html',
        qa_flat_fig = '{qa_dir}/calib2d/{night}/qa-flat-{camera}-{expid:08d}.png',
        qa_ztruth = '{qa_dir}/exposures/{night}/qa-ztruth-{night}.yaml',
        qa_ztruth_fig = '{qa_dir}/exposures/{night}/qa-ztruth-{night}.png',
    ...
    if qa_dir is None and 'qa_dir' in required_inputs:
        qa_dir = qaprod_root()
    ...
    actual_inputs = {
        'specprod_dir':specprod_dir, 'specprod':specprod, 'qa_dir':qa_dir,
