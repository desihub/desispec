...
def findfile(filetype, night=None, expid=None, camera=None, groupname=None,
    ...
    location = dict(
        ...
        ql_countbins_file = '{specprod_dir}/exposures/{night}/{expid:08d}/ql-countbins-{camera}-{expid:08d}.json',
        ql_countbins_arc_fig = '{specprod_dir}/calib2d/{night}/ql-countbinsarc-{camera}-{expid:08d}.png',
        ql_countbins_arc_file = '{specprod_dir}/calib2d/{night}/ql-countbinsarc-{camera}-{expid:08d}.json',
        ql_countpix_fig = '{specprod_dir}/exposures/{night}/{expid:08d}/ql-countpix-{camera}-{expid:08d}.png',
        ql_countpix_file = '{specprod_dir}/exposures/{night}/{expid:08d}/ql-countpix-{camera}-{expid:08d}.json',
        ql_countpix_arc_fig = '{specprod_dir}/calib2d/{night}/ql-countpixarc-{camera}-{expid:08d}.png',
        ql_countpix_arc_file = '{specprod_dir}/calib2d/{night}/ql-countpixarc-{camera}-{expid:08d}.json',
        ql_countpix_bias_fig = '{specprod_dir}/calib2d/{night}/ql-countpixbias-{camera}-{expid:08d}.png',
        ql_countpix_bias_file = '{specprod_dir}/calib2d/{night}/ql-countpixbias-{camera}-{expid:08d}.json',
        ql_countpix_dark_fig = '{specprod_dir}/calib2d/{night}/ql-countpixdark-{camera}-{expid:08d}.png',
        ql_countpix_dark_file = '{specprod_dir}/calib2d/{night}/ql-countpixdark-{camera}-{expid:08d}.json',
        ql_fiberflat_fig = '{specprod_dir}/exposures/{night}/{expid:08d}/ql-fiberflat-{camera}-{expid:08d}.png',
        ql_fiberflat_file = '{specprod_dir}/exposures/{night}/{expid:08d}/ql-fiberflat-{camera}-{expid:08d}.json',
        ql_getbias_fig = '{specprod_dir}/exposures/{night}/{expid:08d}/ql-getbias-{camera}-{expid:08d}.png',
        ql_getbias_file = '{specprod_dir}/exposures/{night}/{expid:08d}/ql-getbias-{camera}-{expid:08d}.json',
        ql_getbias_arc_fig = '{specprod_dir}/calib2d/{night}/ql-getbiasarc-{camera}-{expid:08d}.png',
        ql_getbias_arc_file = '{specprod_dir}/calib2d/{night}/ql-getbiasarc-{camera}-{expid:08d}.json',
        ql_getbias_bias_fig = '{specprod_dir}/calib2d/{night}/ql-getbiasbias-{camera}-{expid:08d}.png',
        ql_getbias_bias_file = '{specprod_dir}/calib2d/{night}/ql-getbiasbias-{camera}-{expid:08d}.json',
        ql_getbias_dark_fig = '{specprod_dir}/calib2d/{night}/ql-getbiasdark-{camera}-{expid:08d}.png',
        ql_getbias_dark_file = '{specprod_dir}/calib2d/{night}/ql-getbiasdark-{camera}-{expid:08d}.json',
        ql_checkHDUs_fig = '{specprod_dir}/exposures/{night}/{expid:08d}/ql-checkHDUs-{camera}-{expid:08d}.png',
        ql_checkHDUs_file = '{specprod_dir}/exposures/{night}/{expid:08d}/ql-checkHDUs-{camera}-{expid:08d}.json',
        ql_getrms_fig = '{specprod_dir}/exposures/{night}/{expid:08d}/ql-getrms-{camera}-{expid:08d}.png',
        ql_getrms_file = '{specprod_dir}/exposures/{night}/{expid:08d}/ql-getrms-{camera}-{expid:08d}.json',
        ql_getrms_arc_fig = '{specprod_dir}/calib2d/{night}/ql-getrmsarc-{camera}-{expid:08d}.png',
        ql_getrms_arc_file = '{specprod_dir}/calib2d/{night}/ql-getrmsarc-{camera}-{expid:08d}.json',
        ql_getrms_bias_fig = '{specprod_dir}/calib2d/{night}/ql-getrmsbias-{camera}-{expid:08d}.png',
        ql_getrms_bias_file = '{specprod_dir}/calib2d/{night}/ql-getrmsbias-{camera}-{expid:08d}.json',
        ql_getrms_dark_fig = '{specprod_dir}/calib2d/{night}/ql-getrmsdark-{camera}-{expid:08d}.png',
        ql_getrms_dark_file = '{specprod_dir}/calib2d/{night}/ql-getrmsdark-{camera}-{expid:08d}.json',
        ql_initial_fig = '{specprod_dir}/exposures/{night}/{expid:08d}/ql-initial-{camera}-{expid:08d}.png',
        ql_initial_file = '{specprod_dir}/exposures/{night}/{expid:08d}/ql-initial-{camera}-{expid:08d}.json',
        ql_initial_arc_fig = '{specprod_dir}/calib2d/{night}/ql-initialarc-{camera}-{expid:08d}.png',
        ql_initial_arc_file = '{specprod_dir}/calib2d/{night}/ql-initialarc-{camera}-{expid:08d}.json',
        ql_initial_bias_fig = '{specprod_dir}/calib2d/{night}/ql-initialbias-{camera}-{expid:08d}.png',
        ql_initial_bias_file = '{specprod_dir}/calib2d/{night}/ql-initialbias-{camera}-{expid:08d}.json',
        ql_initial_dark_fig = '{specprod_dir}/calib2d/{night}/ql-initialdark-{camera}-{expid:08d}.png',
        ql_initial_dark_file = '{specprod_dir}/calib2d/{night}/ql-initialdark-{camera}-{expid:08d}.json',
        ql_integ_fig = '{specprod_dir}/exposures/{night}/{expid:08d}/ql-integ-{camera}-{expid:08d}.png',
        ql_integ_file = '{specprod_dir}/exposures/{night}/{expid:08d}/ql-integ-{camera}-{expid:08d}.json',
        ql_mergedQA_file = '{specprod_dir}/exposures/{night}/{expid:08d}/ql-mergedQA-{camera}-{expid:08d}.json',
        ql_mergedQAarc_file = '{specprod_dir}/calib2d/{night}/ql-mergedQAarc-{camera}-{expid:08d}.json',
        ql_preproc_fig = '{specprod_dir}/exposures/{night}/{expid:08d}/ql-preproc-{camera}-{expid:08d}.png',
        ql_preproc_file = '{specprod_dir}/exposures/{night}/{expid:08d}/ql-preproc-{camera}-{expid:08d}.json',
        ql_preproc_arc_fig = '{specprod_dir}/calib2d/{night}/ql-preprocarc-{camera}-{expid:08d}.png',
        ql_preproc_arc_file = '{specprod_dir}/calib2d/{night}/ql-preprocarc-{camera}-{expid:08d}.json',
        ql_preproc_bias_fig = '{specprod_dir}/calib2d/{night}/ql-preprocbias-{camera}-{expid:08d}.png',
        ql_preproc_bias_file = '{specprod_dir}/calib2d/{night}/ql-preprocbias-{camera}-{expid:08d}.json',
        ql_preproc_dark_fig = '{specprod_dir}/calib2d/{night}/ql-preprocdark-{camera}-{expid:08d}.png',
        ql_preproc_dark_file = '{specprod_dir}/calib2d/{night}/ql-preprocdark-{camera}-{expid:08d}.json',
        ql_resfit_fig = '{specprod_dir}/exposures/{night}/{expid:08d}/ql-resfit-{camera}-{expid:08d}.png',
        ql_resfit_file = '{specprod_dir}/exposures/{night}/{expid:08d}/ql-resfit-{camera}-{expid:08d}.json',
        ql_resfit_arc_fig = '{specprod_dir}/calib2d/{night}/ql-resfitarc-{camera}-{expid:08d}.png',
        ql_resfit_arc_file = '{specprod_dir}/calib2d/{night}/ql-resfitarc-{camera}-{expid:08d}.json',
        ql_skycont_fig = '{specprod_dir}/exposures/{night}/{expid:08d}/ql-skycont-{camera}-{expid:08d}.png',
        ql_skycont_file = '{specprod_dir}/exposures/{night}/{expid:08d}/ql-skycont-{camera}-{expid:08d}.json',
        ql_skyRband_fig = '{specprod_dir}/exposures/{night}/{expid:08d}/ql-skyRband-{camera}-{expid:08d}.png',
        ql_skyRband_file = '{specprod_dir}/exposures/{night}/{expid:08d}/ql-skyRband-{camera}-{expid:08d}.json',
        ql_skypeak_fig = '{specprod_dir}/exposures/{night}/{expid:08d}/ql-skypeak-{camera}-{expid:08d}.png',
        ql_skypeak_file = '{specprod_dir}/exposures/{night}/{expid:08d}/ql-skypeak-{camera}-{expid:08d}.json',
        ql_skyresid_fig = '{specprod_dir}/exposures/{night}/{expid:08d}/ql-skyresid-{camera}-{expid:08d}.png',
        ql_skyresid_file = '{specprod_dir}/exposures/{night}/{expid:08d}/ql-skyresid-{camera}-{expid:08d}.json',
        ql_skysub_fig = '{specprod_dir}/exposures/{night}/{expid:08d}/ql-skysub-{camera}-{expid:08d}.png',
        ql_skysub_file = '{specprod_dir}/exposures/{night}/{expid:08d}/ql-skysub-{camera}-{expid:08d}.json',
        ql_snr_fig = '{specprod_dir}/exposures/{night}/{expid:08d}/ql-snr-{camera}-{expid:08d}.png',
        ql_snr_file = '{specprod_dir}/exposures/{night}/{expid:08d}/ql-snr-{camera}-{expid:08d}.json',
        ql_trace_fig = '{specprod_dir}/exposures/{night}/{expid:08d}/ql-trace-{camera}-{expid:08d}.png',
        ql_trace_file = '{specprod_dir}/exposures/{night}/{expid:08d}/ql-trace-{camera}-{expid:08d}.json',
        ql_xwsigma_fig = '{specprod_dir}/exposures/{night}/{expid:08d}/ql-xwsigma-{camera}-{expid:08d}.png',
        ql_xwsigma_file = '{specprod_dir}/exposures/{night}/{expid:08d}/ql-xwsigma-{camera}-{expid:08d}.json',
        ql_xwsigma_arc_fig = '{specprod_dir}/calib2d/{night}/ql-xwsigmaarc-{camera}-{expid:08d}.png',
        ql_xwsigma_arc_file = '{specprod_dir}/calib2d/{night}/ql-xwsigmaarc-{camera}-{expid:08d}.json',
