...
def findfile(filetype, night=None, expid=None, camera=None, groupname=None,
    ...
    location = dict(
        ...
        ql_bootcalib_file = '{specprod_dir}/exposures/{night}/{expid:08d}/ql-bootcalib-{camera}-{expid:08d}.json',
        ql_boxextract_fig = '{specprod_dir}/exposures/{night}/{expid:08d}/ql-boxextract-{camera}-{expid:08d}.png',
        ql_boxextract_file = '{specprod_dir}/exposures/{night}/{expid:08d}/ql-boxextract-{camera}-{expid:08d}.json',
        ...
        ql_skyresid_fig = '{specprod_dir}/exposures/{night}/{expid:08d}/ql-spectra-{camera}-{expid:08d}.png',
