...
This algorithm is not part of the standard Python library.  However,
there are *similar* algorithms, such as zlib.crc32().  This is equivalent
to the BSD ``cksum -o 3 file``.  This historical algorithm is *not* available
in the GNU version of ``cksum``.  That is, it is not possible to do
``cksum -o 3 file`` on Linux.
"""
