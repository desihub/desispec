...
class DESI_PROC_DASHBOARD(object):
    ...
    Normal Mode:
    desi_proc_dashboard -n all --n_nights 3  --output_dir /global/project/projectdirs/desi/www/users/zhangkai/desi_proc_dashboard/
    desi_proc_dashboard -n 20200101,20200102 --n_nights 3  --output_dir /global/project/projectdirs/desi/www/users/zhangkai/desi_proc_dashboard/
    desi_proc_dashboard -n 20200101 20200102 --n_nights 3  --output_dir /global/project/projectdirs/desi/www/users/zhangkai/desi_proc_dashboard/
    Cron job script:
*/30 * * * * /global/common/software/desi/cori/desiconda/20190804-1.3.0-spec/conda/bin/python3 /global/project/projectdirs/desi/users/zhangkai/desi/code/desispec/py/desispec/desi_proc_dashboard.py -n all --n_nights 30 --output_dir /global/project/projectdirs/desi/www/users/zhangkai/desi_proc_dashboard/ >/global/project/projectdirs/desi/users/zhangkai/desi_proc_dashboard.log 2>/global/project/projectdirs/desi/users/zhangkai/desi_proc_dashboard.err &
