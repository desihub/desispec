...
for missing in ('astropy', 'astropy.modeling',
                'desimodel', 'desitarget', 'desiutil', 'healpy',
                'matplotlib', 'numpy', 'redrock', 'scipy', 'speclite', 'specter',
                'sqlalchemy', 'yaml', 'fitsio', 'numba'):
    try:
